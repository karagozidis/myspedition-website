...
class ControllerUserUserPermission extends Controller
{
    ...
    protected function getForm()
    {
        ...
        if (isset($this->request->post['personal_customers'])) {
            $this->data['personal_customers'] = $this->request->post['personal_customers'];
        } elseif (!empty($user_group_info)) {
            $this->data['personal_customers'] = $user_group_info['personal_customers'];
        } else {
            $this->data['personal_customers'] = '';
        }
        
        if (isset($this->request->post['view_original_data'])) {
            $this->data['view_original_data'] = $this->request->post['view_original_data'];
        } elseif (!empty($user_group_info)) {
            $this->data['view_original_data'] = $user_group_info['view_original_data'];
        } else {
            $this->data['view_original_data'] = '';
        }
