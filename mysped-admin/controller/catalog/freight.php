	...
	private $error = array(); 
  	...
  	public function insert() {
    	...
    	if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {   
			...
			$this->model_catalog_freight->addProduct($this->request->post);
  	...
  	protected function getList() {	
		...
		foreach ($results as $result) {
			...
			$product_specials = $this->model_catalog_freight->getProductSpecials($result['product_id']);
                ...
                $owner = $this->model_sale_customer->getCustomerByFreight($result['freight_id'])   ;
                                
                $view_original_customers = $this->user->viewOriginalData();
                if (!$view_original_customers)
                    {
                    $owner['email'] = $this->user->generateMail();
                    }         
