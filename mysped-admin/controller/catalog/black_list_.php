...
class ControllerCatalogBlacklist extends Controller { 
	...
	private function getList() {
 		...
 		else
		{
			...
			$action[] = array(
				...
				'href' => HTTPS_SERVER . 'index.php?route=catalog/black_list/update&token=' . $this->session->data['token'] . '&black_list_id=' . $result['black_list_id'] . $url
			);
		...
		$this->data['sort_title'] = HTTPS_SERVER . 'index.php?route=catalog/black_list&token=' . $this->session->data['token'] . '&sort=td.title' . $url;
		$this->data['sort_date_added'] = HTTPS_SERVER . 'index.php?route=catalog/black_list&token=' . $this->session->data['token'] . '&sort=t.date_added' . $url;
		$this->data['sort_status'] = HTTPS_SERVER . 'index.php?route=catalog/black_list&token=' . $this->session->data['token'] . '&sort=t.status' . $url;
		$this->data['sort_name'] = HTTPS_SERVER . 'index.php?route=catalog/black_list&token=' . $this->session->data['token'] . '&sort=t.name' . $url;
		$this->data['sort_description'] = HTTPS_SERVER . 'index.php?route=catalog/black_list&token=' . $this->session->data['token'] . '&sort=td.description' . $url;
		...
		$pagination->url = HTTPS_SERVER . 'index.php?route=catalog/black_list&token=' . $this->session->data['token'] . $url . '&page={page}';
	...
	private function getForm($is_edit) {
		...
		if (!isset($this->request->get['black_list_id'])) {
			$this->data['action'] = HTTPS_SERVER . 'index.php?route=catalog/black_list/insert&token=' . $this->session->data['token'] . $url;
		} else {
			$this->data['action'] = HTTPS_SERVER . 'index.php?route=catalog/black_list/update&token=' . $this->session->data['token'] . '&black_list_id=' . $this->request->get['black_list_id'] . $url;
		}
		
		$this->data['cancel'] = HTTPS_SERVER . 'index.php?route=catalog/black_list&token=' . $this->session->data['token'] . $url;

		$this->data['token'] = $this->session->data['token'];
		
		if (isset($this->request->get['black_list_id']) && ($this->request->server['REQUEST_METHOD'] != 'POST')) {
