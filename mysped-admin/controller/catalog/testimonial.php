...
class ControllerCatalogTestimonial extends Controller { 
	...
	private function getList() {
		...
		$this->data['sort_date_added'] = HTTPS_SERVER . 'index.php?route=catalog/testimonial&token=' . $this->session->data['token'] . '&sort=t.date_added' . $url;
		$this->data['sort_status'] = HTTPS_SERVER . 'index.php?route=catalog/testimonial&token=' . $this->session->data['token'] . '&sort=t.status' . $url;
		$this->data['sort_name'] = HTTPS_SERVER . 'index.php?route=catalog/testimonial&token=' . $this->session->data['token'] . '&sort=t.name' . $url;
		$this->data['sort_description'] = HTTPS_SERVER . 'index.php?route=catalog/testimonial&token=' . $this->session->data['token'] . '&sort=td.description' . $url;
