	...
	protected function getForm() {
		...
		if (isset($this->request->post['image'])) {
			...
			$this->data['image'] = '';
                ...
                if (isset($this->request->post['long_image'])) {
			$this->data['long_image'] = $this->request->post['long_image'];
		} elseif (!empty($category_info)) {
			$this->data['long_image'] = $category_info['long_image'];
		} else {
			$this->data['long_image'] = '';
		}
		...
		if (isset($this->request->post['image']) && file_exists(DIR_IMAGE . $this->request->post['image'])) {
			...
			$this->data['thumb'] = $this->model_tool_image->resize('no_image.jpg', 100, 100);
                ...
                if (isset($this->request->post['long_image']) && file_exists(DIR_IMAGE . $this->request->post['long_image'])) {
			$this->data['long_thumb'] = $this->model_tool_image->resize($this->request->post['long_image'], 100, 100);
		} elseif (!empty($category_info) && $category_info['long_image'] && file_exists(DIR_IMAGE . $category_info['long_image'])) {
			$this->data['long_thumb'] = $this->model_tool_image->resize($category_info['long_image'], 100, 100);
		} else {
			$this->data['long_thumb'] = $this->model_tool_image->resize('no_image.jpg', 100, 100);
		}
