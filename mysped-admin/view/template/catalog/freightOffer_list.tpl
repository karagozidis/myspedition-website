          ...
          <tr class="filter">
            ...
            <tr>
              <td style="text-align: center;"><?php if ($product['selected']) { ?>
                <input type="checkbox" name="selected[]" value="<?php echo $product['freight_offer_id']; ?>" checked="checked" />
                <?php } else { ?>
                <input type="checkbox" name="selected[]" value="<?php echo $product['freight_offer_id']; ?>" />
                <?php } ?>
              </td> 
              <td style="background-color: #FF9EAA;">
                 <a style="text-decoration:none;" href="<?php echo $customer_url . $product['offerer_id']; ?>" target="_blank">
                    <b>Company: </b>
                    <?php echo $product['offerer_company']; ?><br>
                    <b>Name: </b>
                    <?php echo $product['offerer_name']; ?>
                 </a>
              </td> 
              <td style="background-color: #FF9EAA;">
                  <?php echo $product['offer_date']; ?>
              </td>
              <td style="background-color: #FF9EAA;">
                  <?php echo $product['price']; ?>
                  <?php echo $product['curreny']; ?>       
              </td>
              
              <td style="background-color: #78CDFD;">
                  <a style="text-decoration:none;" href="<?php echo $customer_url . $product['owner_id']; ?>" target="_blank">
                      <b>Company: </b>
                      <?php echo $product['owner_company']; ?><br>
                      <b>Name: </b>
                      <?php echo $product['owner_name']; ?>
                  </a>
              </td>
              <td style="background-color: #78CDFD;">
                 <?php echo $product['freight_rate']; ?>
              </td>
              <td class="left">
                  <a style="text-decoration:none;" href="<?php echo $freight_url . $product['product_id']; ?>" target="_blank">
...
<script type="text/javascript"><!--
function filter() {
	url = 'index.php?route=catalog/freightOffer&token=<?php echo $token; ?>';
