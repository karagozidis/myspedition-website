      ...
      <form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form">
        <table class="list">
          ...
          <tbody>
            ...
            <tr>
              <td>
                  <input type="checkbox" name="selected[]" value="<?php echo $verification['verification_id']; ?>" />
              </td>
              <td class="left">
                  <a href="<?php echo $verification['customer']['url']; ?>" target="_blank">
                        <?php echo $verification['customer']['company']; ?>
                  </a>
              </td>
              <td><?php  echo $verification['date_added'];  ?></td>
              
              <td>
                  <?php if ( substr($verification['description'] ,0,100) != '' ) echo  substr($verification['description'] ,0,150). "....."; ?>
              </td>
 
              <td class="right">
                  <?php foreach ($verification['action'] as $action) { ?>
