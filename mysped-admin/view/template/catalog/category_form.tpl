      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        ...
        <div id="tab-data">
          <table class="form">
            ...
            <tr>
              <td>Long image <br>
                  <span class="help">Size (750*150)</span>
              
              </td>
              <td valign="top">
                  <div class="image">
                      <img src="<?php echo $long_thumb; ?>" alt="" id="long_thumb" />
                      <input type="hidden" name="long_image" value="<?php echo $long_image; ?>" id="long_image" />
                      <br />
                      <a onclick="image_upload('long_image', 'long_thumb');">
                        <?php echo $text_browse; ?>
                      </a>&nbsp;&nbsp;|&nbsp;&nbsp;
                      <a onclick="$('#long_thumb').attr('src', '<?php echo $no_image; ?>'); $('#long_image').attr('value', '');">
                        <?php echo $text_clear; ?>
                      </a>
                  </div>
              </td>
