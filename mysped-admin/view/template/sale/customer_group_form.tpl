    ...
    <div class="content">
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <table class="form">
          ...
          <tr>
              <td>View customers EMails
                  <span class="help">Can see the customers Email on the company list</span>
              </td>
              
              <td>                          
              <?php if ($view_mail == 1) { ?>
                <input type="radio" name="view_mail" value="1" checked="checked" />
                <?php echo $text_yes; ?>
                <input type="radio" name="view_mail" value="0" />
                <?php echo $text_no; ?>
                <?php } else { ?>
                <input type="radio" name="view_mail" value="1" />
                <?php echo $text_yes; ?>
                <input type="radio" name="view_mail" value="0" checked="checked" />
                <?php echo $text_no; ?>
              <?php } ?>          
              </td>        
          </tr>
          ...
          <tr>
              <td>View customers Telephone
                  <span class="help">Can see the customers Telepone on the company list</span>
              </td>
              
              <td>                          
              <?php if ($view_telephone == 1) { ?>
                <input type="radio" name="view_telephone" value="1" checked="checked" />
                <?php echo $text_yes; ?>
                <input type="radio" name="view_telephone" value="0" />
                <?php echo $text_no; ?>
                <?php } else { ?>
                <input type="radio" name="view_telephone" value="1" />
                <?php echo $text_yes; ?>
                <input type="radio" name="view_telephone" value="0" checked="checked" />
                <?php echo $text_no; ?>
              <?php } ?>          
              </td>        
          </tr>
          ...
          <tr>
              <td>View customers Fax
                  <span class="help">Can see the customers Fax on the company list</span>
              </td>
              <td>                          
              <?php if ($view_fax == 1) { ?>
                <input type="radio" name="view_fax" value="1" checked="checked" />
                <?php echo $text_yes; ?>
                <input type="radio" name="view_fax" value="0" />
                <?php echo $text_no; ?>
                <?php } else { ?>
                <input type="radio" name="view_fax" value="1" />
                <?php echo $text_yes; ?>
                <input type="radio" name="view_fax" value="0" checked="checked" />
                <?php echo $text_no; ?>
              <?php } ?>          
              </td>        
          </tr>
          ...
          <tr>
              <td>View customers Skype
                  <span class="help">Can see the customers Skype on the company list</span>
              </td>
              <td>                          
              <?php if ($view_skype == 1) { ?>
                <input type="radio" name="view_skype" value="1" checked="checked" />
                <?php echo $text_yes; ?>
                <input type="radio" name="view_skype" value="0" />
                <?php echo $text_no; ?>
                <?php } else { ?>
                <input type="radio" name="view_skype" value="1" />
                <?php echo $text_yes; ?>
                <input type="radio" name="view_skype" value="0" checked="checked" />
                <?php echo $text_no; ?>
              <?php } ?>          
              </td>        
          </tr>
          ...
          <tr>
              <td>View customers ICQ
                  <span class="help">Can see the customers ICQ on the company list</span>
              </td>
              <td>                          
              <?php if ($view_icq == 1) { ?>
                <input type="radio" name="view_icq" value="1" checked="checked" />
                <?php echo $text_yes; ?>
                <input type="radio" name="view_icq" value="0" />
                <?php echo $text_no; ?>
                <?php } else { ?>
                <input type="radio" name="view_icq" value="1" />
                <?php echo $text_yes; ?>
                <input type="radio" name="view_icq" value="0" checked="checked" />
                <?php echo $text_no; ?>
              <?php } ?>          
              </td>        
          </tr>
          ...
          <tr>
              <td>View customers Website
                  <span class="help">Can see the customers Website on the company list</span>
              </td>
              <td>                          
              <?php if ($view_website == 1) { ?>
                <input type="radio" name="view_website" value="1" checked="checked" />
                <?php echo $text_yes; ?>
                <input type="radio" name="view_website" value="0" />
                <?php echo $text_no; ?>
                <?php } else { ?>
                <input type="radio" name="view_website" value="1" />
                <?php echo $text_yes; ?>
                <input type="radio" name="view_website" value="0" checked="checked" />
                <?php echo $text_no; ?>
              <?php } ?>          
              </td>        
          </tr>
          ...
          <tr>
              <td>New insertions Appearence delay
                  <span class="help">Delay of appearence (in miniutes) of a new freight , truck , warehouse , product. </span>
              </td>
            <td>                          
                <input type="text" name="view_insertion_delay" value="<?php echo $trucks_number; ?>" size="10" />
            </td>        
          </tr>
          
          <tr>
              <td>Premium design
                  <span class="help">Display a better user interface(if this is a premium account)</span>
              </td>
              <td>                          
              <?php if ($premium_design == 1) { ?>
                <input type="radio" name="premium_design" value="1" checked="checked" />
                <?php echo $text_yes; ?>
                <input type="radio" name="premium_design" value="0" />
                <?php echo $text_no; ?>
                <?php } else { ?>
                <input type="radio" name="premium_design" value="1" />
                <?php echo $text_yes; ?>
                <input type="radio" name="premium_design" value="0" checked="checked" />
                <?php echo $text_no; ?>
              <?php } ?>          
              </td>        
          </tr>
          ...
          <tr>
              <td>Display description
                  <span class="help">Display the description of this customer group</span>
              </td>
              <td>                          
