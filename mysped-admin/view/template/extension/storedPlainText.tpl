          ...
          <div id="language<?php echo $language['language_id']; ?>">
            <table class="form">
              <tr>
                <!--<td>Mail</td>-->
                <td>
                    <textarea name="description[<?php echo $language['language_id']; ?>][description]" id="description<?php echo $language['language_id']; ?>" rows="10" cols="150"><?php if( isset($texts[  $language['language_id']  ]) ) { echo $texts[ $language['language_id']  ]['text']; }  ?></textarea>
                </td>
              </tr>
            </table>
          </div>
