...
<div id="content">
  ...
  <div class="box">
    <div class="heading">
        <h1><img src="view/image/excel.png" alt="" width="22" /> Export to excel </h1>
    </div>
    <div class="content">
        
        <div style="font-size: 200%;"> 
            <a href="<?php echo $customersUrl; ?>" target="_blank" style="text-decoration: none" >
                <img src="view/image/excel.png" alt="" width="36"  /> All Customers 
            </a>
        </div>
        <div style="font-size: 200%;"> 
            <a href="<?php echo $freightsUrl; ?>" target="_blank" style="text-decoration: none" >
               <img src="view/image/excel.png" alt="" width="36" /> All Freights 
            </a>
        </div>
        
        <div style="font-size: 200%;"> 
            <a href="<?php echo $trucksUrl; ?>" target="_blank" style="text-decoration: none" >
               <img src="view/image/excel.png" alt="" width="36" /> All Trucks 
            </a>
        </div>
        
        <div style="font-size: 200%;"> 
            <a href="<?php echo $productsUrl; ?>" target="_blank" style="text-decoration: none" >
               <img src="view/image/excel.png" alt="" width="36" /> All Products 
            </a>
        </div>
