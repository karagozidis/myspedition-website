...
class ModelSaleCustomer extends Model {
	...
	public function addCustomer($data) {
        ...
        public function verifyCustomer($customer_id) {
       ...
       public function unverifyCustomer($customer_id) {
	...
	public function editCustomer($customer_id, $data) {
            ...
            if (isset($data['logo_in_carousel']))
                $logo_in_carousel = $data['logo_in_carousel']; 
            else  $logo_in_carousel  = 0;
                ...
                $sql = "UPDATE " . DB_PREFIX . "customer SET ".
                        ...
                        "', company_type_id = '" . (int)$data['company_type_id'] . 
                        "', user_id = '" . (int)$data['user_id'] . 
                        "', description = '" . $this->db->escape( $data['company_description']) .
                         
                        "', country_id = '" . (int)$data['country_id'] .
                        "', date_purchased = '" . $data['date_purchased'] . 
                        "', verified = '" . (int)$data['verified'] . 
                        "', logo_in_carousel = '" . (int)$logo_in_carousel . 
	...
	public function deleteCustomer($customer_id) {
        ...
        public function getcustomersFreightsTotal($customer_id) {
		$sql =  " SELECT count(oc_freight.freight_id) AS total FROM oc_freight INNER JOIN oc_customer ".
                        " ON oc_freight.customer_id = oc_customer.customer_id ".
        ...
        public function getcustomersTrucksTotal($customer_id) {
		$sql =  " SELECT count(oc_truck.truck_id) AS total FROM oc_truck INNER JOIN oc_customer ".
                        " ON oc_truck.customer_id = oc_customer.customer_id ".
                        " WHERE oc_customer.customer_id = ". $customer_id ." ";
	...
	public function getCustomers($data = array()) {
		...
		$sql = "SELECT *, ".
                       " DATEDIFF(NOW(),c.date_purchased) AS daysPassed , ".
		...
		if (isset($data['filter_user']) && $data['filter_user'] != -1) {
			$implode[] = "c.user_id = '" . (int)$data['filter_user'] . "'";
		}	
		...
		if (!empty($data['filter_date_added'])) {
			$implode[] = "DATE(c.date_added) = DATE('" . $this->db->escape($data['filter_date_added']) . "')";
                ...
                if ( isset($data['filter_payment_status']) && (int)$data['filter_payment_status'] > -1  ) {
                    if ($data['filter_payment_status'] < 3)
                        $implode[] = "payment_status = '" . (int)$data['filter_payment_status'] . "'";
                    if ($data['filter_payment_status'] == 3)
                       $implode[] = " ( (cg.duration - DATEDIFF(NOW(),c.date_purchased) ) <= '3' ) ";
		}
			...
			$implode[] = "DATE(date_added) = DATE('" . $this->db->escape($data['filter_date_added']) . "')";
                ...
                if ( isset($data['filter_payment_status']) && (int)$data['filter_payment_status'] > -1  ) {
                    if ($data['filter_payment_status'] < 3)
                        $implode[] = "payment_status = '" . (int)$data['filter_payment_status'] . "'";
                    if ($data['filter_payment_status'] == 3)
                        $implode[] = " ( (cg.duration - DATEDIFF(NOW(),date_purchased) ) <= '3' ) ";                        
                        //$implode[] = " ( DATEDIFF(NOW(),date_purchased) <= 3 ) ";
		}
