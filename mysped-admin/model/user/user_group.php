...
class ModelUserUserGroup extends Model {
	public function addUserGroup($data) {
		$this->db->query(
                        ...
                        " personal_customers = '" . $this->db->escape($data['personal_customers']) . "',".
                        " view_original_info = '" . $this->db->escape($data['view_original_info']) . "' "
                        );
	}
	...
	public function editUserGroup($user_group_id, $data) {
		...
		$this->db->query(
                        ...
                        " permission = '" . (isset($data['permission']) ? serialize($data['permission']) : '') . "', ".
                        " personal_customers = '" . $this->db->escape($data['personal_customers']) . "', ".
                        " view_original_data = '" . $this->db->escape($data['view_original_data']) . "' " .
	...
	public function getUserGroup($user_group_id) {
		...
		$user_group = array(
			...
			'permission' => unserialize($query->row['permission']),
                        'personal_customers' => $query->row['personal_customers'],
                        'view_original_data' => $query->row['view_original_data']
		);
