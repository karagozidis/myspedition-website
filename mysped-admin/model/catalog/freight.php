...
class ModelCatalogFreight extends Model {
	...
	public function addProduct($data) {
		...
		foreach ($data['product_description'] as $language_id => $value) {
			$this->db->query("INSERT INTO " . DB_PREFIX . "freight_description SET product_id = '" . (int)$product_id . "', language_id = '" . (int)$language_id . "', name = '" . $this->db->escape($value['name']) . "', meta_keyword = '" . $this->db->escape($value['meta_keyword']) . "', meta_description = '" . $this->db->escape($value['meta_description']) . "', description = '" . $this->db->escape($value['description']) . "', tag = '" . $this->db->escape($value['tag']) . "'");
		}
	...
	public function getProduct($product_id) {
		$query = $this->db->query(
                        ...
                        " FROM " . DB_PREFIX . "freight p LEFT JOIN " . DB_PREFIX . "freight_description pd ON (p.freight_id = pd.product_id) WHERE p.freight_id = '" . (int)$product_id . "' AND pd.language_id = '" . (int)$this->config->get('config_language_id') . "'");
	...
	public function getProducts($data = array()) {
		$sql = " SELECT * FROM " . DB_PREFIX . "freight p LEFT JOIN " . DB_PREFIX . "freight_description pd ON (p.freight_id = pd.product_id) ";
                 ...
                 if (!empty($data['filter_email'])) {
                        $sql .=  " INNER JOIN " . DB_PREFIX . "customer c  ON (p.customer_id = c.customer_id) "; 
                 }
