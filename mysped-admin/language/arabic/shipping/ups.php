...
$_['entry_length_class']           = 'نوع الطول:<span class="help">إختر سنتيمتر أو إنش.</span>';
$_['entry_dimension']			   = 'الأبعاد (طول x عرض x ارتفاع):<br /><span class="help">This is assumed to be your average packing box size. Individual item dimensions are not supported at this time so you must enter average dimensions like 5x5x5.</span>';
$_['entry_tax_class']              = 'نوع الضريبة :<br /><span class="help">يفضل اختيار لايوجد</span>';
...
$_['error_password']               = 'مطلوب !';
$_['error_city']                   = 'مطلوب !';
$_['error_state']                  = 'مطلوب !';
$_['error_country']                = 'مطلوب !';
