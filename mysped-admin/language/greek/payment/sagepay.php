...
// Error
$_['error_permission']   = 'Ειδοποίηση: Δεν έχετε άδεια να επεξεργαστείτε τη πληρωμή SagePay!';
$_['error_vendor']       = 'Απαιτείται το Vendor ID!';
$_['error_password']     = 'Απαιτείται το Password!';
?>