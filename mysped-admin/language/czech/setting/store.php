<?php
// Heading
$_['heading_title']                = 'Správce obchodů';

// Text
$_['text_success']                 = 'Úspěch: Změnili jste nastavení obchodů!';
...
$_['text_clear']                   = 'Odstranit obrázek';
...
// Entry
$_['entry_url']                    = 'URL adresa obchodu:<br /><span class="help">Zadejte celou absolutní adresu k obchodu. Ujistěte se že máte \'/\' na konci textu. Například: http://www.yourdomain.com/path/</span>';
$_['entry_ssl']                    = 'Použít SSL:<br /><span class="help">V případě že chcete použít SSL zkontrolujte že server má nastaven SSL certifikát a že je nastavena SSL adresa v konfiguračním souboru.</span>';
$_['entry_name']                   = 'Název obchodu:';
$_['entry_owner']                  = 'Vlastník obchodu:';
...
$_['entry_tax_default']            = 'Použít adresu obchodu pro daň:<br /><span class="help">Použít adresu obchodu k výpočtu daně pokud není uživatel přihlášen. Můžete zvolit použítí výchozí adresy pro fakrurační a doručovací adresu zákazníka.</span>';
$_['entry_tax_customer']           = 'Use Customer Tax Address:<br /><span class="help">Použít výchozí adresu zákazníka, pokud je přihlášen, pro výpočet daně. Můžete zvolit použítí výchozí adresy pro fakrurační a doručovací adresu zákazníka.</span>';
$_['entry_customer_group']         = 'Zákaznická skupina:<br /><span class="help">Výchozí zákaznická skupina.</span>';
$_['entry_customer_group_display'] = 'Zákaznické skupiny:<br /><span class="help">Zobrazit zákaznické skupiny, které nový zákazník může vybrat, jako například velkoprodejce při registraci.</span>';
...
$_['entry_account']                = 'Podmínky registrace:<br /><span class="help">Donutit uživatele odsouhlasit  podmínky před vytvořením účtu.</span>';
...
$_['error_permission']             = 'Varování: Nemáte oprávnění na změnu obchodů!';
...
$_['error_default']                = 'Varování: Nemůžete smazat výchozí obchod!';
$_['error_store']                  = 'Varování: Tento obchod nemůže být smazán je přiřazen k %s objednávkám!';
?>