	...
	protected function index() {
		...
		if (!$this->user->isLogged() || !isset($this->request->get['token']) || !isset($this->session->data['token']) || ($this->request->get['token'] != $this->session->data['token'])) {
			...
			$this->data['customer_ban_ip'] = $this->url->link('sale/customer_ban_ip', 'token=' . $this->session->data['token'], 'SSL');
                        $this->data['catalog_truck'] = $this->url->link('catalog/truck', 'token=' . $this->session->data['token'], 'SSL');
                        $this->data['catalog_freight'] = $this->url->link('catalog/freight', 'token=' . $this->session->data['token'], 'SSL');
                        $this->data['catalog_freight_offer'] = $this->url->link('catalog/freightOffer', 'token=' . $this->session->data['token'], 'SSL');
                       $this->data['catalog_black_list'] = $this->url->link('catalog/black_list', 'token=' . $this->session->data['token'], 'SSL');
                        $this->data['catalog_registrationPayment'] = $this->url->link('catalog/registrationPayment', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['catalog_verification'] = $this->url->link('catalog/verification', 'token=' . $this->session->data['token'], 'SSL');
			...
			$this->data['module'] = $this->url->link('extension/module', 'token=' . $this->session->data['token'], 'SSL');
                        $this->data['excelExports'] = $this->url->link('extension/excel', 'token=' . $this->session->data['token'], 'SSL');
                        $this->data['storedMails'] = $this->url->link('extension/storedMails', 'token=' . $this->session->data['token'], 'SSL');
                        $this->data['freightsMailText'] = $this->url->link('extension/freightsMailText', 'token=' . $this->session->data['token'], 'SSL');
                        $this->data['trucksMailText'] = $this->url->link('extension/trucksMailText', 'token=' . $this->session->data['token'], 'SSL');
                        $this->data['warehousesMailText'] = $this->url->link('extension/warehousesMailText', 'token=' . $this->session->data['token'], 'SSL');
                        $this->data['productsMailText'] = $this->url->link('extension/productsMailText', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['upgradeText'] = $this->url->link('extension/upgradeText', 'token=' . $this->session->data['token'], 'SSL');
                        $this->data['companyViewText'] = $this->url->link('extension/companyViewText', 'token=' . $this->session->data['token'], 'SSL');    
                        $this->data['companyViewLargeText'] = $this->url->link('extension/companyViewLargeText', 'token=' . $this->session->data['token'], 'SSL');  
                        $this->data['upgradeSmallText'] = $this->url->link('extension/upgradeSmallText', 'token=' . $this->session->data['token'], 'SSL');
                        $this->data['upgradeLargeText'] = $this->url->link('extension/upgradeLargeText', 'token=' . $this->session->data['token'], 'SSL');
                        $this->data['accountUpgradeText'] = $this->url->link('extension/accountUpgradeText', 'token=' . $this->session->data['token'], 'SSL');
                         
                        $this->data['keywordsText'] = $this->url->link('extension/keywordsText', 'token=' . $this->session->data['token'], 'SSL');
                        $this->data['mainDescriptionText'] = $this->url->link('extension/mainDescriptionText', 'token=' . $this->session->data['token'], 'SSL');
			...
			$this->data['product'] = $this->url->link('catalog/product', 'token=' . $this->session->data['token'], 'SSL');
                        $this->data['productRequest'] = $this->url->link('catalog/productRequest', 'token=' . $this->session->data['token'], 'SSL');
