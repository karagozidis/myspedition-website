...
class ControllerCatalogFreightOffer extends Controller {
	private $error = array(); 
  	...
  	public function insert() {
			...
			//'limit'           => $this->config->get('config_admin_limit'),
                ...
                $total = $this->model_catalog_freightOffer->getTotalProducts($data);
			...
			$product_id = $this->model_catalog_freightOffer->addProduct($this->request->post);
  	...
  	public function delete() {
		...
		if (isset($this->request->post['selected']) && $this->validateDelete()) {
			foreach ($this->request->post['selected'] as $product_id) {
                            ...
                            $freight = $this->model_catalog_freightOffer->getProduct($product_id);
                            if ( $this->customer->getId() != $freight['customer_id'] )
                                {
                                $this->redirect($this->url->link('freight/upgrade', '', 'SSL'));   
                                }
                            
				$this->model_catalog_freightOffer->deleteProduct($product_id);
	  		}
	...
	$this->load->model('catalog/freightOffer'); 
		...
		$this->data['products'] = array();
                ...
                $freight_id = NULL;
                if ( isset($this->request->get['freight_id']) )
                    {
		...
		$this->load->model('tool/image');
                ...
                $results = $this->model_catalog_freightOffer->getCustomerOffersReceivedDetailed($data);
              	$this->model_catalog_freightOffer->editShown($data);
		...
		$this->data['sort_name'] = $this->url->link('catalog/freightOffer',  $url, 'SSL');
		$this->data['sort_model'] = $this->url->link('catalog/freightOffer', $url, 'SSL');
		$this->data['sort_price'] = $this->url->link('catalog/freightOffer',  $url, 'SSL');
		$this->data['sort_quantity'] = $this->url->link('catalog/freightOffer',  $url, 'SSL');
		$this->data['sort_status'] = $this->url->link('catalog/freightOffer', $url, 'SSL');
		$this->data['sort_order'] = $this->url->link('catalog/freightOffer', $url, 'SSL');
		...
		$pagination->url = $this->url->link('catalog/freightOffer', $url . '&page={page}', 'SSL');
		...
		$this->data['order'] = $order;
                 ...
                 if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/catalog/freightOfferReceived_list.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/catalog/freightOfferReceived_list.tpl';
		} else {
			$this->template = 'default/template/catalog/freightOfferReceived_list.tpl';
		}
  	...
  	protected function getList() {				
		...
		$this->load->model('tool/image');
               ...
               $product_total = $this->model_catalog_freightOffer->getTotalCustomerOffersDetailed($this->customer->getId());
               $results = $this->model_catalog_freightOffer->getCustomerOffersDetailed($this->customer->getId());
		...
		$action[] = array(
				'text' => $this->language->get('text_edit'),
				'href' => $this->url->link('product/freight', '&product_id=' . $result['freight_id'] . $url, 'SSL')
			);
		...
		$this->data['order'] = $order;
                 ...
                 if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/catalog/freightOffer_list.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/catalog/freightOffer_list.tpl';
		} else {
			$this->template = 'default/template/catalog/freightOffer_list.tpl';
		}
  	...
  	protected function getForm() {
		...
		$this->data['cancel'] = $this->url->link('catalog/freightOffer', /*'token=' . $this->session->data['token'] .*/ $url, 'SSL');

		if (isset($this->request->get['product_id']) && ($this->request->server['REQUEST_METHOD'] != 'POST')) {
      		$product_info = $this->model_catalog_freightOffer->getFreightOffer( $this->customer->getId() );
    	}
	...
	/*	if (isset($this->request->post['model'])) {
       ...
       if (isset($this->request->post['trailer_type_id'])) {
        ...
        $freight_total = $this->model_catalog_freightOfferType->getFreights();       
        ...
        $freight_loading_types = $this->model_catalog_freightOfferLoadingType->getLoadingTypes();       
        $this->data['freight_loading_types'] = $freight_loading_types;
        
        $this->load->model('catalog/freightOfferPaymentMethod');    
        $freight_payment_methods = $this->model_catalog_freightOfferPaymentMethod->getPaymentMethods();       
        $this->data['freight_payment_methods'] = $freight_payment_methods;
        
        $this->load->model('catalog/freightOfferPaymentTerms');    
        $freight_payment_terms = $this->model_catalog_freightOfferPaymentTerms->getPaymentTerms();       
	...
	/*	$this->load->model('catalog/category');
		...
		if (isset($this->request->post['product_category'])) {
			...
			$categories = $this->model_catalog_freightOffer->getProductCategories($this->request->get['freight_id']);
		} else {
			$categories = array();
		}*/
		...
		*/
		...
		//$this->data['layouts'] = $this->model_design_layout->getLayout();
                ...
                if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/catalog/freightOffer_form.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/catalog/freightOffer_form.tpl';
		} else {
			$this->template = 'default/template/catalog/freightOffer_form.tpl';
		}
