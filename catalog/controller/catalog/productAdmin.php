<?php 
class ControllerCatalogProductAdmin extends Controller {
	private $error = array(); 
  	...
  	public function index() {
		...
		$this->language->load('catalog/productAdmin');
  	...
  	public function insert() {
    	...
    	if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {   
			...
			$this->model_catalog_productAdmin->addProduct($this->request->post);
			...
			$this->redirect($this->url->link('catalog/productAdmin', /*'token=' . $this->session->data['token'] . */ $url, 'SSL'));
    	}
  	...
  	public function update() {
    	...
    	if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			$this->model_catalog_productAdmin->editProduct($this->request->get['product_id'], $this->request->post);
  	...
  	public function delete() {
		...
		if (isset($this->request->post['selected']) && $this->validateDelete()) {
			foreach ($this->request->post['selected'] as $product_id) {
				$this->model_catalog_productAdmin->deleteProduct($product_id);
	  		}
  	...
  	public function copy() {
		...
		if (isset($this->request->post['selected']) && $this->validateCopy()) {
			foreach ($this->request->post['selected'] as $product_id) {
				$this->model_catalog_productAdmin->copyProduct($product_id);
	  		}
  	...
  	protected function getList() {				
		...
		if (isset($this->request->get['page'])) {
  		...
  		$this->data['breadcrumbs'] = array();
   		...
   		$this->data['breadcrumbs'][] = array(
       		'text'      => " Freight list",
			'href'      => $this->url->link('catalog/productAdmin',/* 'token=' . $this->session->data['token'] . */ $url, 'SSL'),       		
      		'separator' => ' :: '
   		);
		
		$this->data['insert'] = $this->url->link('catalog/productAdmin/insert',/* 'token=' . $this->session->data['token'] .*/ $url, 'SSL');
		$this->data['copy'] = $this->url->link('catalog/productAdmin/copy',/* 'token=' . $this->session->data['token'] .*/ $url, 'SSL');	
		$this->data['delete'] = $this->url->link('catalog/productAdmin/delete',/* 'token=' . $this->session->data['token'] . */$url, 'SSL');
		...
		foreach ($results as $result) {
			...
			$action[] = array(
				...
				'href' => $this->url->link('catalog/productAdmin/update', /*'token=' . $this->session->data['token'] .*/ '&product_id=' . $result['product_id'] . $url, 'SSL')
			);
		...
		$this->data['sort_name'] = $this->url->link('catalog/productAdmin', /*'token=' . $this->session->data['token'] . '&sort=pd.name' . */ $url, 'SSL');
		$this->data['sort_model'] = $this->url->link('catalog/productAdmin',/* 'token=' . $this->session->data['token'] . '&sort=p.model' . */ $url, 'SSL');
		$this->data['sort_price'] = $this->url->link('catalog/productAdmin', /* 'token=' . $this->session->data['token'] . '&sort=p.price' . */ $url, 'SSL');
		$this->data['sort_quantity'] = $this->url->link('catalog/productAdmin', /* 'token=' . $this->session->data['token'] . '&sort=p.quantity' . */ $url, 'SSL');
		$this->data['sort_status'] = $this->url->link('catalog/productAdmin', /* 'token=' . $this->session->data['token'] . '&sort=p.status' . */ $url, 'SSL');
		$this->data['sort_order'] = $this->url->link('catalog/productAdmin', /* 'token=' . $this->session->data['token'] . '&sort=p.sort_order' . */ $url, 'SSL');
		...
		$pagination->url = $this->url->link('catalog/productAdmin',/* 'token=' . $this->session->data['token'] . */ $url . '&page={page}', 'SSL');
		...
		$this->template = 'catalog/productAdmin_list.tpl';
		$this->children = array(
			'common/header',
			'common/footer'
		);
  	...
  	protected function getForm() {
		...
		if (!isset($this->request->get['product_id'])) {
			$this->data['action'] = $this->url->link('catalog/productAdmin/insert', /*'token=' . $this->session->data['token'] . */$url, 'SSL');
		} else {
			$this->data['action'] = $this->url->link('catalog/productAdmin/update', /*'token=' . $this->session->data['token'] . */'&product_id=' . $this->request->get['product_id'] . $url, 'SSL');
		}
		
		$this->data['cancel'] = $this->url->link('catalog/productAdmin', /*'token=' . $this->session->data['token'] .*/ $url, 'SSL');

		if (isset($this->request->get['product_id']) && ($this->request->server['REQUEST_METHOD'] != 'POST')) {
      		$product_info = $this->model_catalog_productAdmin->getProduct($this->request->get['product_id']);
    	}
		...
		if (isset($this->request->post['product_description'])) {
			...
			$this->data['product_description'] = $this->model_catalog_productAdmin->getProductDescriptions($this->request->get['product_id']);
		} else {
		...
		if (isset($this->request->post['model'])) {
			...
			$this->data['zip_code'] = $product_info['zip_code'];
		} else {
      		$this->data['zip_code'] = '';
    	}
        ...
        if (isset($this->request->post['treiler_type_id'])) {
			...
			$this->data['treiler_type_id'] = $product_info['treiler_type_id'];
		} else {
		...
		if (isset($this->request->post['product_store'])) {
			...
			$this->data['product_store'] = $this->model_catalog_productAdmin->getProductStores($this->request->get['product_id']);
		} else {
		...
		if (isset($this->request->post['product_category'])) {
			...
			$categories = $this->model_catalog_productAdmin->getProductCategories($this->request->get['product_id']);
		} else {
			$categories = array();
		}
		...
		*/
		...
		if (isset($this->request->post['product_filter'])) {
			...
			$filters = $this->model_catalog_productAdmin->getProductFilters($this->request->get['product_id']);
		} else {
			$filters = array();
		}
		...
		if (isset($this->request->post['product_attribute'])) {
			...
			$product_attributes = $this->model_catalog_productAdmin->getProductAttributes($this->request->get['product_id']);
		} else {
		...
		if (isset($this->request->post['product_option'])) {
			...
			$product_options = $this->model_catalog_productAdmin->getProductOptions($this->request->get['product_id']);			
		} else {
		...
		if (isset($this->request->post['product_discount'])) {
			...
			$this->data['product_discounts'] = $this->model_catalog_productAdmin->getProductDiscounts($this->request->get['product_id']);
		} else {
		...
		if (isset($this->request->post['product_special'])) {
			...
			$this->data['product_specials'] = $this->model_catalog_productAdmin->getProductSpecials($this->request->get['product_id']);
		} else {
		...
		if (isset($this->request->post['product_image'])) {
			...
			$product_images = $this->model_catalog_productAdmin->getProductImages($this->request->get['product_id']);
		} else {
		...
		if (isset($this->request->post['product_download'])) {
			...
			$product_downloads = $this->model_catalog_productAdmin->getProductDownloads($this->request->get['product_id']);
		} else {
		...
		if (isset($this->request->post['product_related'])) {
			...
			$products = $this->model_catalog_productAdmin->getProductRelated($this->request->get['product_id']);
		} else {
			$products = array();
		}
		...
		foreach ($products as $product_id) {
			$related_info = $this->model_catalog_productAdmin->getProduct($product_id);
		...
		if (isset($this->request->post['product_reward'])) {
			...
			$this->data['product_reward'] = $this->model_catalog_productAdmin->getProductRewards($this->request->get['product_id']);
		} else {
		...
		if (isset($this->request->post['product_layout'])) {
			...
			$this->data['product_layout'] = $this->model_catalog_productAdmin->getProductLayouts($this->request->get['product_id']);
		} else {
		...
		$this->template = 'catalog/productAdmin_form.tpl';
		$this->children = array(
			'common/header',
			'common/footer'
		);
  	...
  	protected function validateForm() { 
    	/*if (!$this->user->hasPermission('modify', 'catalog/productAdmin')) {
	...
	public function autocomplete() {
		...
		if (isset($this->request->get['filter_name']) || isset($this->request->get['filter_model']) || isset($this->request->get['filter_category_id'])) {
			...
			foreach ($results as $result) {
				...
				$product_options = $this->model_catalog_productAdmin->getProductOptions($result['product_id']);	
