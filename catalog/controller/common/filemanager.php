...
//	public $subfolder ='company_1/'; //'company_1/';       
	...
	public function index() {
		...
		$this->data['title'] = "Filemanager";//$this->language->get('heading_title');
	...
	public function directory() {
		...
		if (isset($this->request->post['directory'])) {
			$directories = glob(rtrim(DIR_IMAGE . 'data/' . 'company_'.$this->customer->getId().'/' . str_replace('../', '', $this->request->post['directory']), '/') . '/*', GLOB_ONLYDIR); 
			...
			if ($directories) {
				...
				foreach ($directories as $directory) {
					...
					$json[$i]['attributes']['directory'] = utf8_substr($directory, strlen(DIR_IMAGE . 'data/'  . 'company_'.$this->customer->getId().'/'));
	...
	public function files() {
		...
		if (!empty($this->request->post['directory'])) {
			$directory = DIR_IMAGE . 'data/' . 'company_'.$this->customer->getId().'/'. str_replace('../', '', $this->request->post['directory']);
		} else {
			$directory = DIR_IMAGE . 'data/'  . 'company_'.$this->customer->getId().'/' ;
		}
	...
	public function create() {
		...
		if (isset($this->request->post['directory'])) {
			if (isset($this->request->post['name']) || $this->request->post['name']) {
				$directory = rtrim(DIR_IMAGE . 'data/' . 'company_'.$this->customer->getId().'/' . str_replace('../', '', $this->request->post['directory']), '/');							   
	...
	public function delete() {
		...
		if (isset($this->request->post['path'])) {
                        ...
                        if( $usrFolder != $reqFolder )  {
                                ...
                                //$json['error'] =  $usrFolder . "   ||   " . $reqFolder; 
                        }
			...
			if ($path == rtrim(DIR_IMAGE . 'data/'. 'company_'.$this->customer->getId().'/' , '/')) {
				$json['error'] =  $this->language->get('error_delete');
			}
		} else {
	...
	protected function recursiveFolders($directory) {
		...
		$output .= '<option value="' . utf8_substr($directory, strlen(DIR_IMAGE . 'data/' . 'company_'.$this->customer->getId().'/' )) . '">' . utf8_substr($directory, strlen(DIR_IMAGE . 'data/')) . '</option>';
	...
	public function upload() {
		...
		$this->language->load('common/filemanager');
                ...
                $dir = rtrim(DIR_IMAGE . 'data/'. 'company_'.$this->customer->getId().'/'  . str_replace('../', '', $this->request->post['directory']), '/');
