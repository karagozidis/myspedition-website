...
//	public $subfolder ='company_1/'; //'company_1/';       
			...
			foreach ($files as $file) {
				...
				if (in_array(strtolower($ext), $allowed)) {
					...
					$json[] = array(
						...
						'file'     => utf8_substr($file, utf8_strlen(DIR_IMAGE . 'docs/')),
	...
	public function delete() {
		...
		if (isset($this->request->post['path'])) {
                        $path = rtrim(DIR_IMAGE . 'docs/'  . str_replace('../', '', html_entity_decode($this->request->post['path'], ENT_QUOTES, 'UTF-8')), '/');
	...
	protected function recursiveFolders($directory) {
		...
		$output .= '<option value="' . utf8_substr($directory, strlen(DIR_IMAGE . 'docs/' . 'company_'.$this->customer->getId().'/' )) . '">' . utf8_substr($directory, strlen(DIR_IMAGE . 'docs/')) . '</option>';
