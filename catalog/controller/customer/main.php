...
class ControllerCustomerCustomer extends Controller { 
	...
	public function approve() {
  	...
  	protected function getList() {
		...
		$this->data['heading_title'] = "Companies' List"; //$this->language->get('heading_title');
		...
		$pagination->url = $this->url->link('customer/customer',$url . '&page={page}', 'SSL');
  	...
  	protected function getForm() {
    	$this->data['heading_title'] = "Company";//$this->language->get('heading_title');
		...
		if (isset($this->request->post['address'])) { 
			...
			$this->data['addresses'] = $this->model_customer_customer->getAddresses($this->request->get['customer_id']);
		} else {
