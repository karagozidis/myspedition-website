	...
	public function index() { 
		...
		if ($product_info) {
			...
			$this->data['points'] = $product_info['points'];
                        ...
                        $this->data['country'] = $this->model_localisation_country->getCountry($product_info['country_id']);
                        
                        $this->load->model('localisation/zone');
                        $this->data['zone'] = $this->model_localisation_zone->getZone($product_info['zone_id']);
			...
			if ($product_info['image']) {
				...
				$this->data['thumb'] = '';
                        ...
                        if ( $product_info['customer_id'] != '' && $product_info['customer_id'] > 0 && $this->customer->isLogged() ) 
                            {
                            $this->data['customer_available'] = true;
                            
                            $this->load->model('customer/customer'); 
                            $customer = $this->model_customer_customer->getCustomer($product_info['customer_id']);
			...
			if (($this->config->get('config_customer_price') && $this->customer->isLogged()) || !$this->config->get('config_customer_price')) {
                            ...
                            $tmp_price = $this->currency->format($this->tax->calculate($product_info['price'], $product_info['tax_class_id'], $this->config->get('config_tax')));
                            if ( $product_info['price'] == 0 ) $tmp_price = "----";
