<?php 
class ControllerProductMarket extends Controller {  
	public function index() { 
		$this->language->load('product/market');		
		...
		*/
			...
			if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/product/market_list.tpl')) {
				$this->template = $this->config->get('config_template') . '/template/product/market_list.tpl';
			} else {
				$this->template = 'default/template/product/market_list.tpl';
			}
