<?php 
class ControllerProductTruckCategory extends Controller {  
	public function index() { 
		$this->language->load('product/truckCategory');
		...
		'href'      => $this->url->link('common/home'),
	  		...
	  		$this->document->setTitle($this->language->get('trucks_list_text'));
			$this->document->setDescription($this->language->get('trucks_list_text'));
			$this->document->setKeywords($this->language->get('trucks_list_text'));
			$this->document->addScript('catalog/view/javascript/jquery/jquery.total-storage.min.js');
			
			$this->data['heading_title'] = $this->language->get('trucks_list_text');
			...
			foreach($limits as $limits){
				$this->data['limits'][] = array(
					'text'  => $limits,
					'value' => $limits,
					'href'  => $this->url->link('product/truckCategory', $url . '&limit=' . $limits)
				);
			}
			...
			/* Gia ta pedia tou pinaka start */ 
                        ...
                        $this->data['sort_loading_date'] = $this->url->link('product/truckCategory', $url . '&sort=p.loading_date'.$curOrder ); 
                        
                        $url .= $tmpOrder;
                        $this->data['sort_trailer_type'] = $this->url->link('product/truckCategory', $url . '&sort=p.trailer_type_id' );
                        $this->data['sort_loading_country'] = $this->url->link('product/truckCategory', $url . '&sort=p.loading_country_id' );
                        $this->data['sort_loading_zone'] = $this->url->link('product/truckCategory', $url . '&sort=p.loading_zone_id' );
                        $this->data['sort_loading_city'] = $this->url->link('product/truckCategory', $url . '&sort=p.loading_city' );
                        $this->data['sort_offloading_country'] = $this->url->link('product/truckCategory', $url . '&sort=p.offloading_country_id' );
                        $this->data['sort_offloading_zone'] = $this->url->link('product/truckCategory', $url . '&sort=p.offloading_zone_id' );
                        $this->data['sort_offloading_city'] = $this->url->link('product/truckCategory', $url . '&sort=p.offloading_city' );
			...
			$pagination->url = $this->url->link('product/truckCategory', $url . '&page={page}');
				...
				$this->data['search_trailer_type12'] = "checked";
                       ...
                       //if ( isset($this->request->post['search']) )
                        ...
                        {   
                            ...
                            if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/product/truckCategory_logged.tpl')) {
                                    $this->template = $this->config->get('config_template') . '/template/product/truckCategory_logged.tpl';
                            } else {
                                    $this->template = 'default/template/product/truckCategory_logged.tpl';
                            }
                        }
                        else
                        {
                             if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/product/truckCategory_general.tpl')) {
                                    $this->template = $this->config->get('config_template') . '/template/product/truckCategory_general.tpl';
                            } else {
                                    $this->template = 'default/template/product/truckCategory_general.tpl';
                            }
                        }
      ...
      public function addTrucks($results = array())
        {
