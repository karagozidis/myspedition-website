<?php
class ModelCustomerCustomerGroupPayment extends Model {
	...
	public function deleteCustomerGroupPayment($customer_group_id) {
	...
	public function getCustomerGroupPayments($data = array()) {
                $sql =  "SELECT  * FROM " . DB_PREFIX . "customer_group_payment ";
