...
function initialize() {
  ...
  /*  var lebanonPos = new google.maps.LatLng(34.89494244739732, 38.529052734375);
    ...
    /*****************************************************************************/  
    var vietnamPos = new google.maps.LatLng(16.063300,108.138428);
    var vietnam = new google.maps.Marker({
        position: vietnamPos,
        icon: 'catalog/view/javascript/gmap/Flags/v/Vietnam.png'
    });
    vietnam.setMap(map);
    google.maps.event.addListener(vietnam, 'click', function () {
        window.location.href = "?route=customer/customer&country_id=230";
    });
    /*****************************************************************************/    
    var southKoreaPos = new google.maps.LatLng(36.591825,127.990723);
    var southKorea = new google.maps.Marker({
        position: southKoreaPos,
        icon: 'catalog/view/javascript/gmap/Flags/s/SouthKorea.png'
    });
    southKorea.setMap(map);
    google.maps.event.addListener(southKorea, 'click', function () {
        window.location.href = "?route=customer/customer&country_id=113";
    });
    /*****************************************************************************/ 
    var japanPos = new google.maps.LatLng(36.444485,139.526367);
    var japan = new google.maps.Marker({
        position: japanPos,
        icon: 'catalog/view/javascript/gmap/Flags/j/Japan.png'
    });
    japan.setMap(map);
    google.maps.event.addListener(japan, 'click', function () {
        window.location.href = "?route=customer/customer&country_id=107";
    });
    /*****************************************************************************/
    var omanPos = new google.maps.LatLng(20.502280,56.931152);
    var oman = new google.maps.Marker({
        position: omanPos,
        icon: 'catalog/view/javascript/gmap/Flags/o/Oman.png'
    });
    oman.setMap(map);
    google.maps.event.addListener(oman, 'click', function () {
        window.location.href = "?route=customer/customer&country_id=161";
    });
    /*****************************************************************************/   
    var australiaPos = new google.maps.LatLng(-25.351473,135.087891);
    var australia = new google.maps.Marker({
        position: australiaPos,
        icon: 'catalog/view/javascript/gmap/Flags/a/Australia.png'
    });
    australia.setMap(map);
    google.maps.event.addListener(australia, 'click', function () {
        window.location.href = "?route=customer/customer&country_id=13";
    });
    /*****************************************************************************/ 
    var chilePos = new google.maps.LatLng(-37.463959,-72.509766);
    var chile = new google.maps.Marker({
        position: chilePos,
        icon: 'catalog/view/javascript/gmap/Flags/c/Chile.png'
    });
    chile.setMap(map);
    google.maps.event.addListener(chile, 'click', function () {
        window.location.href = "?route=customer/customer&country_id=43";
    });
    /*****************************************************************************/  
    
    var srilankaPos = new google.maps.LatLng(7.260308,80.90332);
    var srilanka = new google.maps.Marker({
        position: srilankaPos,
        icon: 'catalog/view/javascript/gmap/Flags/s/SriLanka.png'
    });
    srilanka.setMap(map);
    google.maps.event.addListener(srilanka, 'click', function () {
        window.location.href = "?route=customer/customer&country_id=196";
    });
    /*****************************************************************************/   
    var bangladeshPos = new google.maps.LatLng(23.64452,90.21973);
    var bangladesh = new google.maps.Marker({
        position: bangladeshPos,
        icon: 'catalog/view/javascript/gmap/Flags/b/Bangladesh.png'
    });
    bangladesh.setMap(map);
    google.maps.event.addListener(bangladesh, 'click', function () {
        window.location.href = "?route=customer/customer&country_id=18";
    });
    /*****************************************************************************/   
    var yemenPos = new google.maps.LatLng(15.661718,47.647705);
    var yemen = new google.maps.Marker({
        position: yemenPos,
        icon: 'catalog/view/javascript/gmap/Flags/y/Yemen.png'
    });
    yemen.setMap(map);
    google.maps.event.addListener(yemen, 'click', function () {
        window.location.href = "?route=customer/customer&country_id=235";
    });
    /*****************************************************************************/   
    var kuwaitPos = new google.maps.LatLng(29.361381,47.752075);
    var kuwait = new google.maps.Marker({
        position: kuwaitPos,
        icon: 'catalog/view/javascript/gmap/Flags/k/Kuwait.png'
    });
    kuwait.setMap(map);
    google.maps.event.addListener(kuwait, 'click', function () {
        window.location.href = "?route=customer/customer&country_id=114";
    });
    /*****************************************************************************/   
    var bahrainPos = new google.maps.LatLng(26.035345,50.553589);
    var bahrain = new google.maps.Marker({
        position: bahrainPos,
        icon: 'catalog/view/javascript/gmap/Flags/b/Bahrain.png'
    });
    bahrain.setMap(map);
    google.maps.event.addListener(bahrain, 'click', function () {
        window.location.href = "?route=customer/customer&country_id=17";
    });
    /*****************************************************************************/   
    var qatarPos = new google.maps.LatLng(25.387845,51.242981);
    var qatar = new google.maps.Marker({
        position: qatarPos,
        icon: 'catalog/view/javascript/gmap/Flags/q/Qatar.png'
    });
    qatar.setMap(map);
    google.maps.event.addListener(qatar, 'click', function () {
        window.location.href = "?route=customer/customer&country_id=173";
    });
    /*****************************************************************************/   
    var myanmarPos = new google.maps.LatLng(20.872286,95.734863);
    var myanmar = new google.maps.Marker({
        position: myanmarPos,
        icon: 'catalog/view/javascript/gmap/Flags/m/Myanmar.png'
    });
    myanmar.setMap(map);
    google.maps.event.addListener(myanmar, 'click', function () {
        window.location.href = "?route=customer/customer&country_id=146";
    });
    /*****************************************************************************/   
    var thailandPos = new google.maps.LatLng(15.022391,101.096191);
    var thailand = new google.maps.Marker({
        position: thailandPos,
        icon: 'catalog/view/javascript/gmap/Flags/t/Thailand.png'
    });
    thailand.setMap(map);
    google.maps.event.addListener(thailand, 'click', function () {
        window.location.href = "?route=customer/customer&country_id=209";
    });
    /*****************************************************************************/   
    var philippinesPos = new google.maps.LatLng(11.429552,123.947754);
    var philippines = new google.maps.Marker({
        position: philippinesPos,
        icon: 'catalog/view/javascript/gmap/Flags/p/Philippines.png'
    });
    philippines.setMap(map);
    google.maps.event.addListener(philippines, 'click', function () {
        window.location.href = "?route=customer/customer&country_id=168";
    });
    /*****************************************************************************/   
    var taiwanPos = new google.maps.LatLng(23.677857,121.047363);
    var taiwan = new google.maps.Marker({
        position: taiwanPos,
        icon: 'catalog/view/javascript/gmap/Flags/t/Taiwan.png'
    });
    taiwan.setMap(map);
    google.maps.event.addListener(taiwan, 'click', function () {
        window.location.href = "?route=customer/customer&country_id=206";
    });
