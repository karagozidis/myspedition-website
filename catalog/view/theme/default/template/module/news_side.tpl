      ...
      <div class="postSide">
          ...
          <div class="image newSideImg">
              <a href="<?php echo $news_story['href']; ?>">
                  <img src="<?php echo $news_story['thumb']; ?>" width="60" title="<?php echo $news_story['title']; ?>" alt="<?php echo $news_story['title']; ?>" />
              </a>
          </div>
          <?php } ?>
          
          <a class="newsTitle" style="color: #787878;font-size: 120%;" href="<?php echo $news_story['href']; ?>"><?php echo $news_story['title']; ?></a><br />
