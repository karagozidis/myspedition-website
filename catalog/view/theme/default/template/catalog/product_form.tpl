...
<div id="content">
  ...
  <div class="box">
    <div class="heading">
      <h1><img src="image/product.png" width="25" alt="" /> <?php echo $heading_title; ?> </h1>
      <div class="buttons">
          <a class="button submitProduct"><?php echo $button_save; ?></a>
 ...
 <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">        
          ...
          <div id="language<?php echo $language['language_id']; ?>">
            <table class="form">
              <tr>
                ...
                <td> 
                   <input type="text" id="description_title<?php echo $language['language_id']; ?>" name="product_description[<?php echo $language['language_id']; ?>][name]" size="100" value="<?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['name'] : ''; ?>" />
              ...
              <tr>
                ...
                <td>
                    <textarea rows="20" cols="73" name="product_description[<?php echo $language['language_id']; ?>][description]" id="description<?php echo $language['language_id']; ?>">
    ...
    <h3><?php echo $text_category; ?>- <?php echo $text_area; ?>:</h3>   
    <div class="content">
        <table>
              <tr>
                 <td>
   ...
   <div class="buttons">
          <a class="button submitProduct">Save</a>
...
$('#popUp1').SetBubblePopup({
			     innerHtml: '<h1>Product descriptions </h1><p>You are obliged to fill the default (English) language. <br />All the other languages, if they remain empty <br /> they will display the default (English) language.</p>'
			    });
});
//-->
</script>
...
function addDiscount() {
    ...
    <?php } ?>
    html += '    </select></td>';		
    html += '    <td ><input type="text" name="product_discount[' + discount_row + '][quantity]" value="" size="2" /></td>';
    html += '    <td ><input type="text" name="product_discount[' + discount_row + '][priority]" value="" size="2" /></td>';
...
function addSpecial() {
    ...
    <?php } ?>
    html += '    </select></td>';		
    html += '    <td ><input type="text" name="product_special[' + special_row + '][priority]" value="" size="2" /></td>';
...
function addImage() {
	...
	html += '  <tr>';
	html += '    <td ><div class="image"><img src="<?php echo $no_image; ?>" alt="" id="thumb' + image_row + '" /><input type="hidden" name="product_image[' + image_row + '][image]" value="" id="image' + image_row + '" /><br /><a onclick="image_upload(\'image' + image_row + '\', \'thumb' + image_row + '\');"><?php echo $text_browse; ?></a>&nbsp;&nbsp;|&nbsp;&nbsp;<a onclick="$(\'#thumb' + image_row + '\').attr(\'src\', \'<?php echo $no_image; ?>\'); $(\'#image' + image_row + '\').attr(\'value\', \'\');"><?php echo $text_clear; ?></a></div></td>';
