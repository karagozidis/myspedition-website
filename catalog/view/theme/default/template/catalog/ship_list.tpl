          ...
          <tbody>
            ...
            <tr>
              <td style="text-align: center;">
                ...
                <?php } ?></td>
              <td class="center"><img src="image/ship.png" width="25" height="25" alt="<?php echo $product['name']; ?>" style="padding: 1px; border: 1px solid #DDDDDD;" /></td>
             ...
             <!-- <td><?php  echo $product['trailer']['name']  ?></td>-->
              ...
              <td class="right"><?php foreach ($product['action'] as $action) { ?>
                  <a class="button" style="text-decoration: none;" href="<?php echo $action['href']; ?>">Edit</a> 
                <?php } ?></td>
            </tr>
            <?php } ?>
            <?php } else { ?>
