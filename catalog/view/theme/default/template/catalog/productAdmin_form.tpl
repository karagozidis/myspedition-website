      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        ...
        <div id="tab-data">
          <table class="form">
            ...
            <tr>              
              <td>Offloading city</td>
              <td><input type="text" name="offloading_city" value="<?php echo $offloading_city; ?>" /></td>
            </tr>
            
          <!--  <tr>
              <td>Loading date</td>
              <td><input type="text" name="loading_date" value="<?php echo $loading_date; ?>" /></td>
            </tr>-->
            <tr>
              <td>Loading date</td>
            ...
            <tr>
              <td>Treiler type required</td>
              <td>
               <select name="treiler_type_id">
          ...
          <table id="attribute" class="list1">
            <thead>
              <tr>
        ...
        <div id="tab-option">
          ...
          <div id="tab-option-<?php echo $option_row; ?>" class="vtabs-content">
            ...
            <table id="option-value<?php echo $option_row; ?>" class="list1">
              <thead>
                <tr>
