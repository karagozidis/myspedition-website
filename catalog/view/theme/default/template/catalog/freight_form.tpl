...
<div id="content">
  ...
  <div class="box1">
    <div class="heading">
        <h1><img src="image/freight.png" width="25" alt="" /> <?php echo $heading_title; ?></h1>
    ...
    <div class="content1">
      ...
      <div id="tabs" class="htabs">
         ...
         <!-- <a href="#freight_parameters">[2] <?php echo $freight_parameters_text; ?></a>-->
        ...
        <div id="tab-general">
          ...
          <div id="language<?php echo $language['language_id']; ?>">
            <table class="form">
              ...
              <input type="hidden" name="product_description[<?php echo $language['language_id']; ?>][name]" size="100" value="<?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['name'] : ''; ?>" />
              <!-- 
              <tr>
        ...
        <div id="tab-data">
          ...
          <tr class="bottomline">
             <td><?php echo $frequency_text; ?></td>
              <td>
                  <input type="hidden" name="fromCalendar" value="<?php echo $fromCalendar; ?>">
          ...
          <tr>             
           ...
           <tr>             
            ...
            <tr>
              <td>
                  <span class="required">*</span> <?php echo $loading_city_text; ?>                  
              </td>
              <td>
         ...
         <tr id="date_text" >             
            ...
            <tr id="loading_date" >                     
              <td><span class="required">*</span><?php echo $date_text; ?></td>
              <td>
            ...
            <tr id="offloading_date" class="bottomline" >                     
              ...
              <td>
               <select name="trailer_type_id">
                     <?php foreach ($treiler_total as $treiler) { ?>
                        <?php if( $treiler['treiler_type_id'] == $trailer_type_id ) { ?>
                  ...
                  <select name="temperature" <?php if($trailer_type_id != 7 && $trailer_type_id != 9) { ?>style="display:none;"<?php } ?>>
                      <?php for ($i=-25;$i<25;$i++) { ?>
                      <option value="<?php echo $i; ?>" <?php if ($i==$temperature) echo 'selected'; ?>>
                              <?php if($i > 0 ) echo '+'; ?>
                              <?php echo $i; ?> Celcius
            ...
            <tr class="bottomline">
              ...
              <td>
               <select name="number_of_trucks">
                    <?php for ($i = 1; $i <= 10; $i++){ ?> 
                     <?php if ( $number_of_trucks == $i ){ ?> 
              ...
              <!--<td><span class="required">*</span> <?php echo $loading_type_text; ?></td>
              <td>
               <select name="freight_loading_type_id">
                     <?php foreach ($freight_loading_types as $loading_type) { ?>
                        <?php if( $loading_type['loading_type_id'] == $freight_loading_type_id ) { ?>
          ...
          <!--  <tr class="bottomline">
            ...
            <tr>                
              ...
              <td>          
                    <input type="radio" name="freight_params" value="0" class="ftl-ltl" <?php if( $freight_params == 0 ) { ?> checked="checked" <?php } ?>  >Ftl
                    <input type="radio" name="freight_params" value="1"  class="ftl-ltl" <?php if( $freight_params == 1 ) { ?> checked="checked" <?php } ?>  >Ltl 
            ...
            <tr>                                            
             ...
             <tr> 
               <td> <span class="required">*</span> <?php echo $freight_type_text; ?></td>
              <td>
            ...
            <tr>              
              <td><?php echo $freight_rate_text; ?></td>
              ...
              <td>
                  <select name="rate_currency">
                         <?php foreach($currencies as $currency) { ?>
                            <?php if ($currency['currency_id'] == $rate_currency) { ?>
...
<script type="text/javascript">
    ...
    $('select[name=\'trailer_type_id\']').bind('change', function() {
    if ( $('select[name=\'trailer_type_id\']').val() == 7 || $('select[name=\'trailer_type_id\']').val() == 9 )
        {
           $('select[name=\'temperature\']').css("display", "");      
        }
        else 
        {
           $('select[name=\'temperature\']').css("display", "none");   
        }
        
        //alert( $('select[name=\'trailer_type_id\']').val() );
    });
</script>
<script type="text/javascript">
