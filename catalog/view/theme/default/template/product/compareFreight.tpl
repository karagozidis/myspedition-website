  ...
  <table class="compare-info">
    ...
    <tbody>
      ...
      <tr>
        ...
        <?php foreach ($products as $product) { ?>
        <td>         
                <?php echo $products[$product['product_id']]['freight_type']['name']; ?>
        </td>
        <?php } ?>
      </tr>
      ...
      <tr>
        ...
        <?php foreach ($products as $product) { ?>
        <td>         
                <?php echo $products[$product['product_id']]['freightLoadingType']['name']; ?>
        </td>
        <?php } ?>
      </tr>
     ...
     <tr>
      ...
      <tr>
        ...
        <?php foreach ($products as $product) { ?>
        <td>         
            <?php if( $products[$product['product_id']]['t1']== 0 ) { ?>
                <img width="20" src="image/no.png">
            <?php } else { ?>
                <img width="20" src="image/yes.png">
            <?php } ?>              
      ...
      <tr>
        ...
        <?php foreach ($products as $product) { ?>
        <td>         
            <?php if( $products[$product['product_id']]['ex1']== 0 ) { ?>
                <img width="20" src="image/no.png">
            <?php } else { ?>
                <img width="20" src="image/yes.png">
            <?php } ?>              
