...
<div id="content"><?php echo $content_top; ?>
  ...
  <h1>
      <img src="image/freight.png" width=30 height=30>
  ...
  <div class="product-filter">
        ...
        <input type="button" onclick="window.location = '?route=product/compareFreight'" value="<?php echo $compare_text; ?>" id="compare-total" style="background-color: #EFEFEF; border: 1px solid #DDDDDD;padding: 5px; cursor:pointer;"/>
               
        <div class="slidingDiv" style=" padding-bottom:4px; border:1px solid #DDDDDD; background: #FFFFFF; display: none;"  >    
               <form action="?route=product/freightCategory" method="get" enctype="multipart/form-data" id="form">
               <input type="hidden" name="route" value="product/freightCategory">                                       
  ...
  <table class="list1">
          ...
          <tbody>
            ...
            <tr style="cursor:pointer">
              ...
              <td>
                  <a href="?route=customer/customer/update&customer_id=<?php echo $product['owner']['customer_id']; ?>" target="_blank">
                      ...
                      <?php if($product['owner']['cg_image'] != "") { ?>
                        <img src="<?php echo $product['owner']['cg_image']; ?>" width=25>
                      <?php } ?>
              ...
              <td>
                    <a id="compare-total" onclick="addToCompareFreight('<?php echo $product['product_id']; ?>');">
