  ...
  <div class="box1">
    ...
    <div class="content1">
      ...
      <div id="tabs" class="htabs">
          ...
          <a href="#tab-Map" id="tab_Map" onclick="window.setTimeout(resizeMap,1000);"><?php echo $tab_map_text; ?></a>
      </div>
      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        ...
        <div id="tab-data">
         ...
         <?php } else {   ?>
           ...
           <tr>             
              <td style="width: 150px;"><?php echo $loading_country_text; ?></td>
              <td>   
         ...
         <?php } else {   ?>
                    ...
                    <?php if($frequency == 0) { ?>
                       ...
                       <tr>                     
                         ...
                         <td>
                             <input type="text" name="offloading_date" value="<?php echo $offloading_date; ?>" size="12" readonly />
                         </td>
                       </tr>
                        <?php } else { ?>
                            <tr>                     
                                <td colspan="3">
                                    <?php echo $regular_freight_text; ?>
                                </td>                
                            </tr>
                        <?php } ?>
            <?php } ?>
             ...
             <tr>
              ...
              <td>
                ...
                <?php if($treiler_type['treiler_type_id'] == 7 || $treiler_type['treiler_type_id'] == 9 ) { ?>
                    <input type="text" name="treiler_type" 
                           value="<?php if( $temperature > 0 ) echo '+'; ?><?php echo $temperature; ?> Celcius" size="8" readonly>
                <?php } ?>
              </td>
              <td>
                <?php if ($lift == 1) {  ?>
     ...
     <!--       <tr>
              ...
              <td>
                  <?php if ($t1 == 1) {  ?>
                  <img src="image/yes.png" width="20">T1 
                  <?php } else { ?>
                  <img src="image/no.png" width="20">T1
                  <?php } ?>
             </td>
             <td>
                  <?php if ($ex1 == 1) {  ?>
                  <img src="image/yes.png" width="20">EX1
                  <?php } else { ?>
                  <img src="image/no.png" width="20">EX1
                  <?php } ?>
              </td>
            </tr>-->
            ...
            <tr>
              ...
              <td>
                 <input type="text" name="number_of_trucks" value="<?php echo $number_of_trucks; ?>" readonly /> 
              </td>
            ...
            <tr class="bottomline">
              <td><?php echo $loading_type_text; ?></td>
              <td>
                 <input type="text" name="freight_loading_type" value="<?php echo $freight_loading_type['name']; ?>" readonly /> 
              </td>
            </tr>
            ...
            <tr>
              <td><?php echo $freight_type_text; ?></td>
              <td>                
                   <input type="text" name="freight_type" value="<?php echo $freight_type['name']; ?>" readonly />                              
              </td>
           ...
           <tr>
              <td><?php echo $payment_terms_text; ?></td>
              <td>
                <input type="text" name="freight_payment_term" value="<?php echo $freight_payment_term['name']; ?>" readonly />                         
              </td>
           </tr>
           ...
           <tr class="bottomline">
              ...
              <td>
                   <input type="text" name="freight_payment_method" value="<?php echo $freight_payment_method['name']; ?>" readonly />                                              
              </td>
           </tr>
             
           <tr>              
               <td style="font-size: 130%;"><?php echo $freight_rate_text; ?></td>
               <td>
                   <input type="text" style=" background-color: #99FFCC; " name="freight_rate" value="<?php echo $freight_rate; ?>" readonly />
                   <?php echo $rate_currency; ?>
    ...
    <?php } ?>
        ...
        <div id="tab-Map">
           ...
           <tr> 
            ...
            <tr>              
                <td>
                    <?php echo $to_text; ?>
                    <input type="text" id="toArea" value="<?php echo $offloading_country['name']; ?>,<?php if ( isset($offloading_zone['name']) ) echo $offloading_zone['name']; ?>,<?php echo $offloading_city; ?>"> 
                </td>
                <td>
           ...
           <tr> 
            ...
            <tr>
                <td colspan="5" align="top" valign="top">
                    <div id="map" style="width: 950px; height: 500px; border: 1px solid #FDC5C5;"></div>
                </td>  
            </tr>
      ...
      <form action="<?php echo $offerAction; ?>" method="post" enctype="multipart/form-data">
       
         <?php if($isOwner == true) { ?> 
         <table>
             <tr>
                 <td>
                    <img src="image/offer.png" width="50px;">
                 </td>
                 <td>
                    <h2>Companies Offers for this freight</h2>
                 </td>
             <tr>
         </table>
         <?php } else { ?>
         <table>
             <tr>
                 ...
                 <td>
                    <h2>Your offers for this freight</h2>
                 </td>
             </tr>
         </table>
         <?php } ?>
          ...
          <?php if($isOwner == true) { ?> 
           ...
           <?php if( isset($freightOffers) ) { ?>
              <table>
                <?php $count = 1 ?>
                <?php foreach( $freightOffers as $freightOffer ) { ?>
                <tr>
                    <td><b><?php echo $count++; ?>)</b> &nbsp;</td>
                    <td><b>Date:</b></td>
                    <td>
                        <?php echo $freightOffer['date_added']; ?> &nbsp;&nbsp;&nbsp;
                    </td>
                    
                    <td><b>Price:</b></td>
                    <td>
                        <?php echo $freightOffer['price']; ?>&nbsp;&nbsp;&nbsp;
                    </td>
                    <td><b>Company:</b></td>
                    <td>
                        <a href="index.php?route=customer/customer/update&customer_id=<?php echo $freightOffer['customer_id'];  ?>" target="_blank">
                        <?php echo $freightOffer['company']; ?>&nbsp;&nbsp;&nbsp;
                        </a>
                    </td>
               </tr>
                <?php } ?>
             ...
             <?php } ?>
             <a class="button" href="<?php echo $offerDetailsUrl; ?>" target="_blank">Details</a>
          ...
          <?php } else { ?>
            <?php if( isset($freightOffers) ) { ?>
              <table>
                ...
                <tr>
                    ...
                    <td><b>Price:</b></td>
                    <td>
                        <?php echo $freightOffer['price']; ?>&nbsp;&nbsp;&nbsp;<?php echo $rate_currency; ?>
                    </td>
               </tr>
                <?php } ?>
              </table>
            ...
            <table>
                <tr>
                    ...
                    <td>     
                        <b style="font-size: 150%;"> Make a new offer</b>
                    </td>
                    <td>
                    <img src="image/plus.png" width="20px;">
                    </td>
            ...
            Price
            <input type="text" name="price" value="" /> &nbsp;<?php echo $rate_currency; ?> &nbsp;&nbsp;&nbsp;
...
/*$("#SbmBtn").show(function() { 
    resizeMap();
    alert('dfdfd');
});
$('#SbmBtn').show(0, onDivShow);
function onDivShow() { 
alert('dfdfd');
}*/
//--></script> 
...
<script type="text/javascript"><!--
/*
$('#tab-Map').bind('mouseout', function() {
alert('dfdfd');
});
$('#tab-Map').trigger('mouseout');*/
//--></script> 
