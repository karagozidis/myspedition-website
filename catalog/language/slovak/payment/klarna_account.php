...
$_['text_success']          = 'Success: You hav modified Klarna Payment module!';
...
$_['entry_servr']          = 'Servr:';
$_['entry_total']           = 'Total:<br /><span class="help">The checkout total the order must reach before this payment method becomes activ.</span>';
...
// Error
$_['error_permission']      = 'Warning: You do not hav permission to modify payment Klarna Part Payment!';
$_['error_pclass']          = 'Could not retriev pClass for %s. Error Code: %s; Error Message: %s';
