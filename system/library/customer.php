			...
			$this->address_id = $customer_query->row['address_id'];
                        ...
                        $query = 
                                $this->db->query(
                                        ...
                                        " WHERE cg.customer_group_id = '" . (int)$customer_query->row['customer_group_id']. "' ".
                                        " AND cgd.language_id = '" . (int)$this->config->get('config_language_id') . "'");
                        
                        $this->customer_group =  $query->row;
	...
	public function logout() {
  	...
  	public function getRewardPoints() {
        ...
        public function getCustomerGroup() {
             ...
             $query = 
                       $this->db->query(
                                ...
                                " LEFT JOIN " . DB_PREFIX . "customer_group_description cgd ".
                                " ON (cg.customer_group_id = cgd.customer_group_id) ". 
                                " WHERE cg.customer_group_id = '".(int)$this->customer_group_id."' ".
                                " AND cgd.language_id = '".(int)$this->config->get('config_language_id')."'");
        ...
        public function getProductsNumber() {
             ...
             $query = 
                       $this->db->query(
                                "SELECT DISTINCT c.products_number FROM " . DB_PREFIX . "customer c ".
                                " WHERE c.customer_id = '".(int)$this->customer_id."' ");
                                       
              return $query->row['products_number'];	        
  	}
